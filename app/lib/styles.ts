...
export const input = 'w-full px-4 py-2.5 rounded-lg border border-gray-200 text-sm text-[#1a1a1a] focus:outline-none focus:ring-2 focus:ring-[#1a1a1a] focus:border-transparent disabled:bg-gray-50 disabled:text-gray-400'

export const select = 'w-full px-4 py-2.5 rounded-lg border border-gray-200 text-sm text-[#1a1a1a] bg-white focus:outline-none focus:ring-2 focus:ring-[#1a1a1a] focus:border-transparent disabled:bg-gray-50 disabled:text-gray-400'

export const card = 'bg-white rounded-2xl border border-gray-100 shadow-sm'

export const sectionTitle = 'text-sm font-bold text-[#1a1a1a] uppercase tracking-wide mb-4'

export const label = 'block text-sm font-medium text-gray-500 mb-1'
