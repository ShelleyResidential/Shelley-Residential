...
// Syncs ONE page (up to 1000) of a user's Google contacts into our contacts
...
// Different agents can each have their own contact row for the same real
// person (e.g. two agents both have a shared client saved in their own
// phone) -- that's expected, not a bug; the Contacts list shows who
// captured each one so it's never ambiguous whose copy you're looking at.
//
